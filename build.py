...
subs = {
    ...
    **{("{{IC_ex16%s%s}}" % (n.capitalize(), suf)): ex16(n, col) for n in ["location", "locationFill", "arrowDown", "frontDesk", "filter", "sort", "calendar"] for suf, col in [("", "#212121"), ("Cyan", "#26BEC9")]},  # 預設統一 #212121（filter.svg 原為 black）
